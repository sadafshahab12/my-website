...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: "bg-pearion-dark text-white hover:bg-pearion-dark focus:ring-pearion-dark shadow-sm hover:shadow-md",
    secondary: "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 focus:ring-gray-200 shadow-sm",
    outline: "bg-transparent border border-pearion-dark text-pearion-dark hover:bg-pearion-dark focus:ring-pearion-dark",
